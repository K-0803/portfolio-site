...
<template>
  ...
  >
    ...
    <link
      ...
      rel="stylesheet"
    />
    <div class="max-w-4xl bg-while mx-auto sm:px-6 lg:px-8">
      <!-- <a
        ...
        <div class = "mt-4 pt-4 text-gray-800 border-t border-dashed">
          <div id = "about_link">
            ...
            <ul>
              ...
              <p>よく読むジャンル</p>
              <p>推理小説、SF（ファンタジーのみも好み）</p><br>
              <p>最近はまっている本・おすすめの本</p>
              <p>裏世界ピクニック（著 宮澤伊織、ハヤカワ文庫JA）<a href = ""></a></p>
              <p>図書館の魔女    （著 高田大介、講談社文庫）<a href = ""></a></p>
              <p>神様の御用人    （著 浅葉なつ、メディアワークス文庫）<a href = ""></a></p>
            </ul>
        ...
        <div class = "mt-4 pt-4 text-gray-800 border-t border-dashed">
          ...
          <ul>
            <li class = "s_title">404NotFoundページ作成</li>
              <img src = "20220831_screenshot.png" alt = "" width = "250">
              <p>実習で作成。動きは少ないが、個人的には気に入っている。</p>
              <p>実際に作成したものはこちら⇒<a id = "indent" href = "404notfound/404.html" target = "_blank">404NotFoundページ</a></p><br>
