    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          ここはSugimoto Kazumasaのポートフォリオサイトです。<br>
          習得スキル内容やこれまでに作成した作品が掲載されています。
        </p>
        <br>
        <div class = "nav">
        <SquareBox color1 = "#ff0000" text = "About"/>
        <SquareBox color1 = "#7c0202" text = "About"/>
        <SquareBox color1 = "#ffff00" text = "About"/>
        <SquareBox color1 = "#00ffff" text = "About"/>
        </div>
      </div>
